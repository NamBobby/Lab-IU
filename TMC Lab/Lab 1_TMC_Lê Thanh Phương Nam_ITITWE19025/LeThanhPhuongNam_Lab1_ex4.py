...
Original file is located at
    https://colab.research.google.com/drive/1hWXchAVLPkpQiIdBrhMVwn6xo-Fksnx6
"""

import math as m

x = float(input('Number to approximate: '))

while x == 0:
    print('f(0) does not exist, please try again!')
    x = float(input('Please enter a differnt number: '))
...
print("\nLeThanhPhuong_ITITWE19025_Lab 1_Ex4")